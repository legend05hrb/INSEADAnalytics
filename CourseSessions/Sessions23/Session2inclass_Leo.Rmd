...
##### Answers:
1. Majority of the questions are not correlated(with coefficient lower than 0.5), but some are correlated:Q3 and Q9. 
2. They correlated items imply similarity between the questions. Those correlated questions belong to same category and stand for similar information.
<br>
<br>
<br>
<br>
...
**Your Answers here:**
1. The table shows the variance explained by the components using PCA method. The first 5 components explain over 50% of the variance. The scree plot show the relationship between aigenvalues and number of components to explain the variance. The number of components should be determined by selecting the number of components above the elbow of the curve, where the aigenvalues are also greater than 1.

2. It indicates that with the number of components increasing, the aigenvalues are decreasing, which is saying that the upcoming components are no longer to a large extent explaining the variance as the first several components.

3. The first several components explains the most variance. Because there are certain level of correlation between each questions. Certain amount of questions could be grouped together to decrease the amount of variables. Except from that, even if the questions are not designed to be repeated, questions could be grouped based on information category as well. 
<br>
<br>
<br>
<br>
...
**Your Answers here:**
1. It most sense for most of the correlation between factors and questions. But there are some noise, such as Q27, Q28 are grouped together with branding and status, while they're related to buyer's passion for boat. 
