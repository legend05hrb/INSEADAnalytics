...
1. 6, up to component 6, so that cummulative variance explained is over 50%. 
2. 5 yr T-Notes and 10yr T-Notes have the highest weight of 0.93.
3. They are agricultural commodities. The Eigenvalue of the first 10 compotents are all above 1, and the minimnum percentage of explained variance is 2.04%. The accumulative percentage of explained variance is greater than 50%, which is 62.61%. These components are call principal component.
4. 
a) the pre-crisis bull market years (e.g. only using the data between November 1, 2002, and October 1, 2007)
...
b) the financial crisis years (e.g. only using the data between October 1, 2007 and March 1, 2009)
...
5. Overall market performance is easily affected by macro factors(such as bond rate) in bear market. 
...
**Your Answers here:**
1. The code is calculating the moving average of different "window length" of each futures, and trying to use this average as the best future trading strategy.

2. By changing the moving average windown, the growth trend changes. 
<br>
<br>
<br>
<br>
